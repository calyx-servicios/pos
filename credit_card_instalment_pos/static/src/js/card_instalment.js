    ...
    show: function (options) {
        ...
        if (options) {
			if (options.auto_close) {
				...
				self.close();
				self.$el.find('.popup').append('<div class="footer"><button class="button accept card_btn" id="btn-accept">Continuar</button><button class="button cancel card_btn">Cerrar</button></div>');
			}
